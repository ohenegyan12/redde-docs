            ...
            <>
              ...
              <div className="content-section">
                ...
                <div style={{
                  ...
                  <span style={{ wordBreak: 'break-all', marginRight: '16px', minWidth: 0, flex: 1 }}>{checkoutMode === 'live' ? 'https://api.reddeonline.com/v1/checkout/' : 'https://demoapi.reddeonline.com/v1/checkout/'}</span>
                  <button
  ...
  "successcallback": "https://example.com/success"
                ...
                <div style={{ marginTop: '32px' }}>
                  ...
                  <div style={{
                    ...
                    color: '#CFCFD5',
                    border: '1px solid rgba(255, 255, 255, 0.05)',
                    position: 'relative', overflowX: 'auto', wordBreak: 'break-all', width: '100%', maxWidth: '100%', boxSizing: 'border-box'
                  }}>
                    <button
...
"checkouttransid": null
              ...
              <div className="content-section" style={{ marginTop: '48px', paddingTop: '48px', borderTop: '1px solid var(--border-color)' }}>
                ...
                <div style={{
                  ...
                  <span style={{ wordBreak: 'break-all', marginRight: '16px', minWidth: 0, flex: 1 }}>https://demoapi.reddeonline.com/v1/checkoutstatus/{'{checkouttransid}'}</span>
                  <button
            ...
            <>
              ...
              <div className="content-section">
                ...
                <div style={{
                  ...
                  <span style={{ wordBreak: 'break-all', marginRight: '16px', minWidth: 0, flex: 1 }}>{restMode === 'live' ? 'https://api.reddeonline.com/v1/receive' : 'https://demoapi.reddeonline.com/v1/receive'}</span>
                  <button
            ...
            <>
              ...
              <div className="content-section">
                ...
                <div style={{
                  ...
                  <span style={{ wordBreak: 'break-all', marginRight: '16px', minWidth: 0, flex: 1 }}>{restMode === 'live' ? 'https://api.reddeonline.com/v1/cashout' : 'https://demoapi.reddeonline.com/v1/cashout'}</span>
                  <button
            ...
            <>
              ...
              <div className="content-section">
                ...
                <div style={{
                  ...
                  <span style={{ wordBreak: 'break-all', marginRight: '16px', minWidth: 0, flex: 1 }}>{restMode === 'live' ? 'https://api.reddeonline.com/v1/status/{transactionid}' : 'https://demoapi.reddeonline.com/v1/status/{transactionid}'}</span>
                  <button
